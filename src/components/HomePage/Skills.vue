<script setup lang="ts">
  ...
  import { skillsData } from '@/store/store';
</script>

<template>
  <section id="skills" class="relative w-full border-t my-12 lg:my-24 border-[#25213b]">
    ...
    <div class="w-full my-12">
      ...
      >
        <div
          ...
          :key="id"
          class="w-36 min-w-36 h-fit flex flex-col items-center justify-center transition-all duration-500 m-3 sm:m-5 rounded-lg group relative hover:scale-[1.15] cursor-pointer"
        >
